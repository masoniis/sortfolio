<div class="skill" data-hover-text="NVIM">
	<span class="sr-only">Neovim</span>
	<svg viewBox="0 0 128 128">
		<defs>
			...
			>
				...
				<stop offset="1" stop-color="#0f59b2" stop-opacity=".835294"></stop>
			</linearGradient>
			<linearGradient
				id="b"
				x1="0.5"
			...
			>
				...
				<stop offset="1" stop-color="#439240" stop-opacity=".839216"></stop>
			</linearGradient>
		</defs>
		<g fill-rule="evenodd">
			<path
				fill="url(#a)"
				d="M.426 33.703 33.383.426v154.722L.426 122.258Zm0 0"
				transform="translate(10.95 -.352) scale(.82614)"
			></path>
			<path
				fill="url(#b)"
				d="M127.773 34 94.406.426l.676 154.722L128 122.254Zm0 0"
				transform="translate(10.95 -.352) scale(.82614)"
			></path>
			<path
				fill="url(#c)"
				d="m33.379.637 85.691 130.75-23.98 23.976L9.355 24.903Zm0 0"
				transform="translate(10.95 -.352) scale(.82614)"
			></path>
			<path
				fill-opacity="0.129412"
				d="m38.53 50.01-.04 4.244-21.743-32.18 2.014-2.06zm0 0"
			></path>
		</g>
	</svg>
</div>
